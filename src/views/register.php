        ...
        <div class="container">
            ...
            <div class="form-container">
                ...
                <form action="../../controllers/funtion_register.php" method="post">
                    ...
                    <input type="lastname" id="lastname" name="lastname" class="input-field" placeholder="Apellido"
                        required>
                    <input type="name-user" id="nickname" name="nickname" class="input-field"
                        placeholder="Nombre de Usuario" required>
                    <input type="email" id="email" name="email" class="input-field" placeholder="Correo electrónico"
                        required>
