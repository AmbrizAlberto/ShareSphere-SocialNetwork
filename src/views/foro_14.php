  ...
  <div class="main">
    ...
    <div class="filtros" style="top: 25%;">
      <div class="containerfiltros">
        ...
        <div class="forum">
          <button onclick="window.location.href='../views/foro_6.php'"><img src="../images/6.png" style="position: relative; top: 50%;"></button>
          <button onclick="window.location.href='../views/foro_7.php'"><img src="../images/7.png" style="position: relative; top:70%"></button>
        </div>
