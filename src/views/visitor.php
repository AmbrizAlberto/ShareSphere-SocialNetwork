    ...
    <div class="main">
        ...
        <?php foreach($postList as $post){?>
          ...
          <div class="post-container">
            <div class="user-info">
              <a href="<?php echo "/src/views/visitorUserPage.php?idPerfil=".$post['creatorId']; ?>"> <img src="<?php echo "/public/images_users/". $posts->GetUserImgById($post['creatorId']) ?>" alt="User Image"></a>
